...
import com.arrived.service.DishService;
...
public class DishServiceImpl implements DishService {
    ...
    public void deleteBatch(List<Long> ids) {
        System.out.println("setmealDishMapper: " + setmealDishMapper);
