package com.arrived.aspect;


import com.arrived.annotation.AutoFill;
import com.arrived.constant.AutoFillConstant;
...
//    切入点
    ...
    @Pointcut("execution(* com.arrived.mapper.*.*(..))&& @annotation(com.arrived.annotation.AutoFill)")
